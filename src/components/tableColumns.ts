...
export const COLUMNS: Record<ActiveView, ColumnDef[]> = {
  resumo: [
    ...
    { key: 'perc_dia1', label: '% Dia 1', sortable: true, cls: 'td-num td-pct', kind: 'pct' },
    { key: 'lidos_dia2', label: 'Qtd Dia 2', sortable: true, cls: 'td-num', kind: 'intAbbr' },
    { key: 'perc_dia2', label: '% Dia 2', sortable: true, cls: 'td-num td-pct', kind: 'pct' },
    { key: 'lidos_dia3', label: 'Qtd Dia 3', sortable: true, cls: 'td-num', kind: 'intAbbr' },
    { key: 'perc_dia3', label: '% Dia 3', sortable: true, cls: 'td-num td-pct', kind: 'pct' },
  ],
  seduc: [
